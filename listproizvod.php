...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    echo '<div class="tblselected"><div class="naziv">Proizvod: '. $row["proizvod"],'<br><span class="kolicina"> Boja: '. $row["boja"],"<br> Veličina:  " . $row["velicina"]." " . $row["vrsta"]. "</span></div>  " , '<div class="kolicina">Naručena količina: '. $row["kolicina"].' komada.</div><div class="izbrisi"><a href="proizvod.php?cartId=7">Izbrisi</a></div></div>'
    ;
  }
} else {
  echo "0 results";
...
<h3>Ukupna cijena je: <?php echo finalnaCijena($proizvod, $velicina, $boja, $slika, $kolicina) ?>KM</h3><br>
